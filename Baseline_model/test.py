...
model_path = 'O-Haze'
# model_path = 'RESIDE_ITS'

args = {
    # 'snapshot': 'iter_40000_loss_0.01230_lr_0.000000',
     'snapshot': 'iter_20000_loss_0.05625_lr_0.000000',
    ...
    with torch.no_grad():
        ...
        for name, root in to_test.items():
            ...
            for idx, data in enumerate(dataloader):
                ...
                os.makedirs(os.path.join(ckpt_path, model_path,
                                         '(%s) %s_%s' % (model_path, name, args['snapshot'])),exist_ok=True)

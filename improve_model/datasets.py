...
def make_dataset_hazerd(root:str):
    img_list = []
    for img_name in os.listdir(os.path.join(root,'hazy')):
        assert os.path.exists(os.path.join(root,'gt',img_name))
        img_list.append([os.path.join(root,'hazy',img_name),os.path.join(root,'gt',img_name)])

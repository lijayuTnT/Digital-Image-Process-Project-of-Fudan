...
if __name__ == '__main__':
    ...
    val_root = os.path.join(ohaze_root,'val')
    ...
    val_list = [img_name for img_name in os.listdir(ori_haze_root)
                    if int(img_name.split('_')[0]) >= 36 and int(img_name.split('_')[0]) <=40 ]
    test_list = [img_name for img_name in os.listdir(ori_haze_root)
                  if int(img_name.split('_')[0]) >= 41 and int(img_name.split('_')[0]) <=45]
